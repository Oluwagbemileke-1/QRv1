...
urlpatterns = [
    ...
    path('<uuid:event_id>/generate-qr/', views.generate_event_qr, name='generate_event_qr'),
    ...
    path('<uuid:event_id>/preview-assign/', views.preview_assign, name='preview_assign'),
